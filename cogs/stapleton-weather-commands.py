...
**Latency:** {round(self.bot.latency * 1000)}ms'''
    ...
    async def source_command(self, ctx: commands.Context):
        await ctx.send("Check out the source code for Stapleton County Weather Services and help add to the bot here: https://github.com/LIPDProductionsInc/Stapleton_Weather")
        pass
